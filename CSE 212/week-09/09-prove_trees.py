...
class BST:
    ...
    """
        ...
        # The data belongs on the left side.
            ...
            # We found an empty spot, insert the new node.
                node.left = BST.Node(data)
            else:
            # Need to keep looking. Recursively call _insert
        ...
        # If data is equal to node.data, it's a duplicate value.
        # Do nothing to maintain unique values in the tree.
            pass
    ...
    """
        if node is not None:
            yield from self._traverse_backward(node.right)  # Traverse right subtree
            yield node.data  # Provide data in current node
            yield from self._traverse_backward(node.left)  # Traverse left subtree
