...
print(summarize_degrees("week-06/census.txt"))
# You might need to add a path for the file
...
def is_anagram(word1, word2):
    ...
    word2 = word2.lower().replace(" ", "")  # Convert to lowercase and remove spaces

    if len(word1) != len(word2):  # Check if the lengths are different
        return False

    # Count the occurrences of each letter in both words
    letter_count1 = {}
    letter_count2 = {}
    for letter in word1:
    ...
    # Check if the letter counts are the same for both words
